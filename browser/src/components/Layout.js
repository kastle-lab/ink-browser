...
function Layout(layout) {
  ...
  const type = <div className='quadrant'><Type data={data} bindings={bindings} typeIsPending={typeIsPending} setCoordinates={setCoordinates} endpoint={layout.endpoint}></Type></div>;
