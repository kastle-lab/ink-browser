...
function Layout(layout) {
  ...
  return (
    <div className='gridlayout'>
      ...
      {topLeft == 'Class Hierarchy' && <div className='quadrant'><h2>Class Hierarchy</h2></div>}
      {topLeft == 'Client' && <div className='quadrant'><h2>Client</h2></div>}
      {topLeft == 'Search' && <div className='quadrant'><h2>Search</h2></div>}
      ...
      {topRight == 'Search' && <div className='quadrant'><h2>Search</h2></div>}
      ...
      {bottomLeft == 'Search' && <div className='quadrant'><h2>Search</h2></div>}
      ...
      {bottomRight == 'Search' && <div className='quadrant'><h2>Search</h2></div>}
